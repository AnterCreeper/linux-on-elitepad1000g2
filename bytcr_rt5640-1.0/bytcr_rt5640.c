...
#define BYT_RT5640_LINEOUT_AS_HP	BIT(26)
...
static void log_quirks(struct device *dev)
{
	...
	if (byt_rt5640_quirk & BYT_RT5640_LINEOUT_AS_HP)
		dev_info(dev, "quirk LINEOUT_AS_HP enabled\n");
				    ...
				    struct snd_kcontrol *k, int event)
{
	...
	/*
	 * On devices which use line-out as headphone output,
